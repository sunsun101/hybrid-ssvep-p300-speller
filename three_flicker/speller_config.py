...
FREQS: list = [10, 12 ,13, 15]

POSITIONS: list = [(-600,300), (-600, -150), (600, -150), (600, 300)]

AMPLITUDE: float = 1.0

PHASES: list = [0 , 0 , 0, 0]

TARGET_CHARACTERS:list = ["A", "B", "C", "D"]

SERIAL_PORT:str = "COM3"
BOARD_ID:int = 8
PARTICIPANT_ID:str = "anuj_20230425"
RECORDING_DIR:str = "three_flicker/record"
TYPE_OF_FILE:str = ".fif"
CSV_DIR:str = "csv/"
BLOCK_BREAK:int = 20
MARKERS:dict = {"A": 1.0, "B": 2.0, "C": 3.0, "D": 4.0}